...
ProjectItem = Backbone.View.extend({
	...
	loadTasks: function() {
		 ...
		 */
		$('#project-title span').html(this.model.get('userFirstName'));
		 ...
		 */
		currentProjectId = this.model.userId;
		 ...
		 */
		tasks.fetch({data: {project: this.model.taskId}, processData: true, success: function() {
			/*
